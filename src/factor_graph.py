    ...
    def rm_keyframe(self, ix):
        ...
        with self.video.get_lock():
            ...
            if self.video.uncertainty_aware:
                ...
                self.video.uncertainties_inv_raw[ix] = self.video.uncertainties_inv_raw[ix+1]
                self.video.dynamic_scores[ix] = self.video.dynamic_scores[ix+1]
                self.video.static_evidence[ix] = self.video.static_evidence[ix+1]
                self.video.temporal_priors[ix] = self.video.temporal_priors[ix+1]
