...
class PoseTrajectoryFiller:
    ...
    def __fill(self, timestamps, images, depths, intrinsics, dino_features):
        ...
        # Temporarily append non-keyframes to the tail of the queue. If anything
        # fails during full-trajectory filling, restore the counter so a
        # low-memory retry can start from a consistent state.
